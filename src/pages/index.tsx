  ...
  return (
    <>
      ...
      <div className="flex min-h-screen w-full items-center justify-center bg-dark">
        <div className=" font-wix text-white">
          <p className="py-2 text-center text-xl">
            Oops, looks like its raining.
          </p>
          <div className="space-y-2">
            <p>
              This app was originally hosted with a Planetscale database on
              their legacy free tier plan.
            </p>
            <p>That free plan no longer exists.</p>
            <p>
              For now, this site will be inactive until I migrate to a different
              provider. Apologies.
            </p>
          </div>
        </div>
